...
class FamilyIssueItem extends StatefulWidget {
  const FamilyIssueItem({Key? key, required this.issue}) : super(key: key);

  final FamilyIssueModel issue;

  @override
  _FamilyIDetailPageState createState() => _FamilyIDetailPageState();
}

class _FamilyIDetailPageState extends State<FamilyIssueItem> {
