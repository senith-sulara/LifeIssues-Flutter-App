...
class FamilyCreatePage extends StatefulWidget {
  FamilyCreatePage({Key? key}) : super(key: key);
...
class _FamilyCreatePageState extends State<FamilyCreatePage> {
  ...
  FamilyInsert socialInsert = FamilyInsert();
  int _selected = 0;
  String? errorText;
  bool validate = false;
  bool circular = false;
          ...
          child: FloatingActionButton.extended(
            onPressed: () {
              if (_formKey.currentState!.validate() || validate) {
                ...
                print(data);
                var result = socialInsert.post("/familyIDetails/insert", data);
                if (result == null) {
