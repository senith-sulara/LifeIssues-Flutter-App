...
import 'package:flutterfront/screens/UserSocial/socialSolution.dart';
...
class SocialSolutionUser extends StatefulWidget {
  const SocialSolutionUser({Key? key}) : super(key: key);

  @override
  _SocialParentState createState() => _SocialParentState();
}

class _SocialParentState extends State<SocialSolutionUser> {
  ...
  Widget build(BuildContext context) {
    ...
    //     _jobController.text = documentSnapshot['jobstatus'];
    //     // _civilController.text = documentSnapshot['civilstatus'];
    //   }
    // }
          ...
          onPressed: () {
            if (_globalkey.currentState!.validate() || validate) {
              ...
              if (result == null) {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => SocialIssuesInFive()),
                );
              }
            } else {
              Fluttertoast.showToast(
