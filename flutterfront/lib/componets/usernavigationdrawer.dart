...
import 'package:flutterfront/screens/about.dart';
...
import 'package:flutterfront/screens/terms_and_conditions.dart';
  ...
  switch (i) {
    ...
    case 1:
      Navigator.of(context).push(
          CustomPageRoute(child: Familys(), direction: AxisDirection.left));
      break;
    case 2:
      Navigator.of(context).push(CustomPageRoute(
          child: SocialSolutionUser(), direction: AxisDirection.left));
      break;
    case 3:
      Navigator.of(context).push(
          CustomPageRoute(child: Health(), direction: AxisDirection.left));
      break;
    case 4:
      Navigator.of(context).push(CustomPageRoute(
          child: FinanceFormPage(), direction: AxisDirection.left));
      break;
    case 5:
      Navigator.of(context).push(
          CustomPageRoute(child: AboutPage(), direction: AxisDirection.left));
      break;
    case 6:
      Navigator.of(context).push(CustomPageRoute(
          child: TermsAndConditionsPage(), direction: AxisDirection.left));
      break;
    case 7:
      Navigator.of(context).push(
